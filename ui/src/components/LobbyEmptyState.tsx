...
export function LobbyEmptyState({ onCreate, onImport }: LobbyEmptyStateProps) {
  return (
    <div className="flex flex-1 items-center justify-center px-6 py-16 bg-[radial-gradient(ellipse_60%_50%_at_50%_30%,var(--brand-wash)_0%,transparent_70%)]">
      <div className="flex w-full max-w-xl flex-col items-center text-center">
        <div
          className="flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-wash border border-brand/20 text-brand"
          aria-hidden="true"
        >
          <Building2 className="h-7 w-7" />
        </div>
        <h1 className="mt-6 text-2xl font-bold tracking-[-0.02em] text-text">
          Welcome to AoA<span className="text-brand">.</span>
        </h1>
        <p className="mt-2 max-w-md text-sm text-dim leading-relaxed">
