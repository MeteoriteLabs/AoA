/**
 * @fileoverview Frontend API client for the AoA plugin system.
 *
...
/** Company-level plugin setting returned by the company plugin settings endpoint. */
export interface CompanyPluginSetting {
  pluginId: string;
  pluginKey: string;
  displayName: string;
  description: string;
...
export const pluginsApi = {
  ...
  /** Update enable/disable state for a plugin in a specific company. */
  updateCompanyPluginSetting: (
    companyId: string,
    pluginId: string,
