...
const STORAGE_KEY = "aoa.companyPaths";
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (selectionSource !== "route_sync" && selectedCompany) {
        ...
        const relativePath = savedPath ? toCompanyRelativePath(savedPath) : "/home";
        const targetPath = isRememberableCompanyPath(relativePath) ? relativePath : "/home";
