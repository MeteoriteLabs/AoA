export const queryKeys = {
  companies: {
    ...
    forIdentity: (identityKey: string) =>
      ["companies", "identity", identityKey] as const,
  ...
  routines: {
    ...
    activity: (companyId: string, id: string) =>
      ["routines", companyId, id, "activity"] as const,
  ...
  trustScores: {
    ...
    detail: (companyId: string, agentId: string) =>
      ["trust-scores", companyId, agentId] as const,
  },
  access: {
  ...
  team: {
    ...
    member: (companyId: string, userId: string) =>
      ["team", companyId, "member", userId] as const,
    dependencies: (companyId: string, userId: string) =>
      ["team", companyId, "dependencies", userId] as const,
    workload: (companyId: string, userId: string) =>
      ["team", companyId, "member", userId, "workload"] as const,
    capabilities: (companyId: string, userId: string) =>
      ["team", companyId, "member", userId, "capabilities"] as const,
  },
  teams: {
    list: (companyId: string) => ["teams", companyId] as const,
    detail: (companyId: string, teamId: string) =>
      ["teams", companyId, teamId] as const,
    detailBySlug: (companyId: string, slug: string) =>
      ["teams", companyId, "by-slug", slug] as const,
    members: (companyId: string, teamId: string) =>
      ["teams", companyId, teamId, "members"] as const,
    member: (teamId: string, agentId: string) =>
      ["teams", teamId, "members", agentId] as const,
    coordination: (companyId: string, teamId: string) =>
      ["teams", companyId, teamId, "coordination"] as const,
  },
  auth: {
  ...
  onboarding: {
    journey: ["onboarding", "journey"] as const,
    journeyForIdentity: (identityKey: string) =>
      ["onboarding", "journey", "identity", identityKey] as const,
  },
  adapters: {
  ...
  companyHealth: (companyId: string) =>
    ["health", "company", companyId] as const,
  ...
  secrets: {
    ...
    runtimeProviderKeys: (companyId: string) =>
      ["runtime-provider-keys", companyId] as const,
    bindings: (secretId: string) => ["secret-bindings", secretId] as const,
    accessEvents: (secretId: string) =>
      ["secret-access-events", secretId] as const,
  },
  github: {
    patStatus: (companyId: string) =>
      ["github", "patStatus", companyId] as const,
  },
  providers: {
  ...
  hubItems: {
    ...
    preferences: (companyId: string) =>
      ["hub-items", companyId, "preferences"] as const,
  ...
  sidebarPreferences: (companyId: string) =>
    ["sidebar-preferences", companyId] as const,
  viewerPreferences: (companyId: string) =>
    ["viewer-preferences", companyId] as const,
  ...
  org: Object.assign((companyId: string) => ["org", companyId] as const, {
  ...
  memory: {
    ...
    versions: (companyId: string, id: string) =>
      ["memory", companyId, id, "versions"] as const,
    semanticSearch: (companyId: string, q: string) =>
      ["memory", companyId, "semantic-search", q] as const,
  ...
  mcpConnectors: {
    ...
    catalog: (companyId: string) =>
      ["mcp-connectors", companyId, "catalog"] as const,
  },
  detectedOutputs: {
    byIssue: (issueId: string) =>
      ["detected-outputs", "issue", issueId] as const,
  ...
  environments: {
    ...
    detail: (companyId: string, id: string) =>
      ["environments", companyId, id] as const,
  },
  cockpit: (companyId: string) => ["cockpit", companyId] as const,
  cockpitCounts: (companyId: string) =>
    ["cockpit", companyId, "counts"] as const,
  plugins: {
    ...
    companySettings: (companyId: string) =>
      ["plugins", "company-settings", companyId] as const,
  },
};
