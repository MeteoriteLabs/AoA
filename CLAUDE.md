...
- **Per-company config** (`internal_agent_config` table): executionMode, provider, model, autonomyLevel (**default Assist/1** since 2026-07-23 — was Manual/0; a shared dial read by Commander, crew task runs, org heartbeat, and Adjutant scope-compilation until the D18 split lands; see Decision #109 addendum), enabledCapabilities (12 types), budget, proactive interval.
