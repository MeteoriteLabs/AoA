  ...
  return [
    {
      ...
      execute: async (params: unknown, ctx) => {
        ...
        // List discussions with scope filters
        ...
        // Filter by phase in JS if provided
    ...
    },
    {
      ...
      description:
        "List extracted items from a thread (decisions, tasks, insights, references, etc).",
      parameters: {
        type: "object",
        properties: {
          threadId: {
          ...
          status: {
            type: "string",
            description:
              'Filter by item status: "pending" | "approved" | "rejected" | "edited"',
          },
          type: {
            type: "string",
            description:
              'Filter by item type: "decision" | "task" | "insight" | "context" | "reference" | "preference"',
          },
        },
        required: ["threadId"],
      },
      ...
      execute: async (params: unknown, ctx) => {
        ...
        // Query extracted items for this thread via JOIN with entries
        ...
        return {
          success: true,
          data: filtered,
          summary: `Found ${filtered.length} extracted item(s)`,
        };
      },
    },
  ];
