...
Only call tools that exist in your tool list. If a skill references a tool you don't have, flag it — don't attempt the call. The 37 tools in TOOLS.md are your complete set.
