...
vi.mock("@armyofagents/db", () => ({
  ...
  assets: {
    id: "asset_id",
    originalFilename: "asset_original_filename",
  ...
  artifacts: {
    ...
    type: "art_type",
    title: "art_title",
    currentVersionId: "art_current_version_id",
  },
  artifactVersions: {
    id: "art_version_id",
    filename: "art_version_filename",
    contentType: "art_version_content_type",
    storageKind: "art_version_storage_kind",
    versionNumber: "art_version_number",
  },
