  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: "Fallback if the ACP agent asks for input outside an interactive session. AoA still auto-approves permissions by default.",
      },
      {
        key: "cwd",
        label: "Working directory",
        type: "text",
        hint: "Absolute fallback directory. AoA execution workspaces can override this at runtime.",
      },
      {
        key: "stateDir",
        label: "State directory",
        type: "text",
        hint: "Optional ACPX session state directory. Defaults to AoA-managed company/agent scoped storage.",
      },
      {
        key: "fastMode",
