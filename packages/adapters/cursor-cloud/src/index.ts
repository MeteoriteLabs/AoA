...
Use when:
- You want AoA to run Cursor Cloud Agents through the official Cursor SDK
- You want durable remote Cursor agent sessions across AoA heartbeats
- You want AoA to keep task state while Cursor handles remote code execution
