...
// ---------------------------------------------------------------------------
// Plugin Input DTOs — used by plugin-registry service
// ---------------------------------------------------------------------------
...
export interface UpsertPluginConfig {
  configJson: Record<string, unknown>;
}

/** Input for partially updating a plugin's instance configuration via shallow merge. */
export interface PatchPluginConfig {
  configJson: Record<string, unknown>;
}

/** Input for setting a scoped plugin state entry. */
export interface SetPluginState {
  scopeKind: PluginStateScopeKind;
  scopeId?: string | null;
  namespace?: string;
  stateKey: string;
...
/** Filter for listing scoped plugin state entries. */
export interface ListPluginState {
  scopeKind?: PluginStateScopeKind;
  scopeId?: string;
  namespace?: string;
}
