import type { PluginLauncherRegistration } from "@armyofagents/plugin-sdk";

export const PLUGIN_ID = "aoa-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".aoa-kitchen-sink-demo.txt",
} as const;
