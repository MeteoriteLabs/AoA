/**
 * `@armyofagents/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@armyofagents/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@armyofagents/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@armyofagents/plugin-sdk/ui";
 *
