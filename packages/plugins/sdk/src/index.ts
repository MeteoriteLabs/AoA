 ...
 * import { definePlugin, runWorker, z } from "@armyofagents/plugin-sdk";
 *
...
// Manifest and constant types re-exported from @armyofagents/shared
 ...
 * @example
 * ```ts
 * import { z } from "@armyofagents/plugin-sdk";
 *
