...
ALTER TABLE "environments" ADD COLUMN "driver" text DEFAULT 'local' NOT NULL;--> statement-breakpoint
ALTER TABLE "environments" ADD COLUMN "status" text DEFAULT 'active' NOT NULL;--> statement-breakpoint
ALTER TABLE "environments" ADD COLUMN "config" jsonb DEFAULT '{}'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "environments" ADD COLUMN "metadata" jsonb;--> statement-breakpoint
