CREATE TABLE "aoa_agent_triggers" (
...
CREATE INDEX "aoa_triggers_company_agent_idx" ON "aoa_agent_triggers" USING btree ("company_id","agent_id");--> statement-breakpoint
CREATE INDEX "aoa_triggers_company_kind_enabled_idx" ON "aoa_agent_triggers" USING btree ("company_id","kind","enabled");--> statement-breakpoint
...
CREATE INDEX "ia_runs_agent_idx" ON "internal_agent_runs" USING btree ("company_id","agent_id");