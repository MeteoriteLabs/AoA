CREATE TABLE "discussion_entry_attachments" (
...
CREATE TABLE "scope_item_dependencies" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "thread_inbox_items" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "thread_plan_steps" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"thread_id" uuid NOT NULL,
...
CREATE INDEX "discussion_entry_attachments_entry_idx" ON "discussion_entry_attachments" USING btree ("discussion_entry_id");--> statement-breakpoint
CREATE INDEX "scope_item_dependencies_blocker_idx" ON "scope_item_dependencies" USING btree ("blocker_item_id");--> statement-breakpoint
CREATE INDEX "scope_item_dependencies_blocked_idx" ON "scope_item_dependencies" USING btree ("blocked_item_id");--> statement-breakpoint
CREATE INDEX "thread_inbox_items_company_status_idx" ON "thread_inbox_items" USING btree ("company_id","status");--> statement-breakpoint
CREATE INDEX "thread_links_from_idx" ON "thread_links" USING btree ("from_thread_id");--> statement-breakpoint
CREATE INDEX "thread_links_to_idx" ON "thread_links" USING btree ("to_thread_id");--> statement-breakpoint
CREATE INDEX "thread_participants_thread_idx" ON "thread_participants" USING btree ("thread_id");--> statement-breakpoint
CREATE INDEX "thread_participants_principal_idx" ON "thread_participants" USING btree ("principal_type","principal_id");--> statement-breakpoint
CREATE INDEX "thread_participants_company_idx" ON "thread_participants" USING btree ("company_id");--> statement-breakpoint
CREATE UNIQUE INDEX "thread_participants_unique" ON "thread_participants" USING btree ("thread_id","principal_type","principal_id");--> statement-breakpoint
CREATE INDEX "thread_plan_steps_thread_idx" ON "thread_plan_steps" USING btree ("thread_id");--> statement-breakpoint
