...
--> statement-breakpoint
ALTER TABLE "issues" ADD COLUMN "origin_kind" text;--> statement-breakpoint
ALTER TABLE "issues" ADD COLUMN "origin_id" text;--> statement-breakpoint
ALTER TABLE "issues" ADD COLUMN "origin_run_id" uuid;--> statement-breakpoint
...
CREATE INDEX "issues_open_routine_execution_uq" ON "issues" USING btree ("origin_kind","origin_id") WHERE origin_kind IS NOT NULL AND status NOT IN ('done', 'cancelled');