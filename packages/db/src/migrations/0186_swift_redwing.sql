CREATE TABLE "home_board_layouts" (
...
CREATE INDEX "home_board_layouts_company_idx" ON "home_board_layouts" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "home_board_layouts_user_idx" ON "home_board_layouts" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "home_board_layouts_user_company_uq" ON "home_board_layouts" USING btree ("user_id","company_id");