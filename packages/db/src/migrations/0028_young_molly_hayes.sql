...
CREATE INDEX "debriefs_company_status_idx" ON "debriefs" USING btree ("company_id","status");--> statement-breakpoint
...
CREATE INDEX "task_dep_dependency_idx" ON "task_dependencies" USING btree ("company_id","dependency_issue_id");--> statement-breakpoint
ALTER TABLE "companies" DROP COLUMN "vision";--> statement-breakpoint
ALTER TABLE "companies" DROP COLUMN "mission";--> statement-breakpoint
ALTER TABLE "companies" DROP COLUMN "values";