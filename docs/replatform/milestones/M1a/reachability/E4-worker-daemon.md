...
candidate exactly.
★ **Both gate records carry `Result: fail`** — spine at `a5`, mechanism at `a6` —
`../qa/2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a5.md` and
`../qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a6.md`.
