...
candidate exactly.
★ **Spine `a6` = `Result: pass`; mechanism `a7` = `Result: fail`** —
`../qa/2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a6.md` and
`../qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a7.md`.
