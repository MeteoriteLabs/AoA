...
| [`reachability/`](./reachability/) | One candidate-specific reachability ledger per epic, E3–E6. **Skeletons**: filled at candidate freeze. | *"E3–E6 have candidate-specific ledgers showing which mechanisms are production-reachable rather than merely present and which clauses are certified only by `M1-D1-SPINE`"* |
