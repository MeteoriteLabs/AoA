# QA Result — `M1a-D2-MECHANISM`, M1a candidate, `7be35ae6b771`, attempt 6

**Date (UTC):** `2026-09-23`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a6.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `6`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a5.md`
...
- **Satisfies, as evidence rather than as a gate verdict,** exit criterion 5's *"explicit observation
  ...
  made.
- **Companion record:** `./2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a5.md`, also `fail`.
...
### 11.1 What a passing attempt 7 would need
...
- **(a)** add a fault-matrix step to `m1-shipped-boot.yml` that runs the `M1a-D2-MECHANISM` profile —
  ...
  run on the candidate under the F8 envelope and file attempt 7 with `Supersedes` naming this path;
  **or**
