# QA Result — `M1-D1-SPINE`, M1a candidate, `7be35ae6b771`, attempt 11

**Date (UTC):** `2026-09-23`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a11.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `11`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a10.md`
**Lane:** `M1-D1-SPINE`
**Result:** `fail`
...
### 9.1 What a passing attempt 12 needs — one case, no keyed spend, and it must not be vacuous
...
5. File attempt 12 with `Supersedes` naming this path.
