# QA Result — `M1-D1-SPINE`, M1a candidate, `7be35ae6b771`, attempt 14

**Date (UTC):** `2026-09-24`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1-d1-spine-m1a-candidate-7be35ae6b771-a14.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `14`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1-d1-spine-m1a-candidate-7be35ae6b771-a13.md`
**Lane:** `M1-D1-SPINE`
**Result:** `fail`
...
## 0.000000000000 Why attempt 14 exists — and why I stopped claiming to have swept
...
### 9.1 What a passing attempt 15 needs — one case, no keyed spend, and it must not be vacuous
...
5. File attempt 15 with `Supersedes` naming this path.
