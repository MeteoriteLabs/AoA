# QA Result — `M1-D1-SPINE`, M1a candidate, `7be35ae6b771`, attempt 8

**Date (UTC):** `2026-09-23`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a8.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `8`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a7.md`
**Lane:** `M1-D1-SPINE`
**Result:** `fail`
...
uncertified.** See `./2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a9.md`, which carries
`Result: fail`.
...
### 9.1 What a passing attempt 9 needs — one case, and no keyed spend
...
4. File attempt 9 with `Supersedes` naming this path.
