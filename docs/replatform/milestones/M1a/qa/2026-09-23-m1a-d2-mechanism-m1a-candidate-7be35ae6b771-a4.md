# QA Result — `M1a-D2-MECHANISM`, M1a candidate, `7be35ae6b771`, attempt 4

**Date (UTC):** `2026-09-23`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a4.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `4`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a3.md`
...
| `cat /c/m1a-evid/keyed/m1-shipped-boot-keyed-35920425288/env-probe-a.json` — and the same command on `/c/m1a-evid/keyed/m1-shipped-boot-keyed-35920425288/env-probe-b.json` | `0` | <1 s | `verdict absent`, `present []`, `plantedControl.red true`, `de08MetadataResidual.reachable true` (§7) |
...
- **Satisfies, as evidence rather than as a gate verdict,** exit criterion 5's *"explicit observation
  ...
  made.
- **Companion record:** `./2026-09-23-m1-d1-spine-m1a-candidate-7be35ae6b771-a4.md`, also `fail`.
...
### 11.1 What a passing attempt 5 would need
...
- **(a)** add a fault-matrix step to `m1-shipped-boot.yml` that runs the `M1a-D2-MECHANISM` profile —
  ...
  run on the candidate under the F8 envelope and file attempt 5 with `Supersedes` naming this path;
  **or**
