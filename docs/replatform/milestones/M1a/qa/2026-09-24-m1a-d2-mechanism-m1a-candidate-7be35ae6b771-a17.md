# QA Result — `M1a-D2-MECHANISM`, M1a candidate, `7be35ae6b771`, attempt 17

**Date (UTC):** `2026-09-24`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a17.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `17`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a16.md`
...
## 0.000000000000000 Why attempt 17 exists
...
|---|---|---|
| §11 gate effect | spine **`a14`** | ★ **LIVE** — the attempt a reader should rely on; re-pointed here |
...
### 11.1 What a passing attempt 18 would need — three preconditions, not one step
...
**Then** file attempt 18 with `Supersedes` naming this path.
