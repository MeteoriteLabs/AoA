# QA Result — `M1a-D2-MECHANISM`, M1a candidate, `7be35ae6b771`, attempt 11

**Date (UTC):** `2026-09-23`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a11.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `11`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a10.md`
...
## 0.000000000 Why attempt 11 exists
...
### 11.1 What a passing attempt 12 would need — three preconditions, not one step
...
**Then** file attempt 12 with `Supersedes` naming this path.
...
★ **What needs no keyed spend.** The two cases routed here from the spine (§5 F-9) can be run **keylessly on the spine lane**, whose `worker-b` already has dispatch enabled — subject to the live-lease requirement the spine record's §9.1 sets out, since a restart after a completed attempt reconciles an empty candidate store and would check nothing.
