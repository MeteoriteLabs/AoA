# QA Result — `M1-D1-SPINE`, M1a candidate, `7be35ae6b771`, attempt 15

**Date (UTC):** `2026-09-24`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1-d1-spine-m1a-candidate-7be35ae6b771-a15.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `15`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1-d1-spine-m1a-candidate-7be35ae6b771-a14.md`
**Lane:** `M1-D1-SPINE`
**Result:** `fail`
...
## 0.0000000000000000 Why attempt 15 exists — and how the companion-link loop is closed
...
### 9.1 What a passing attempt 16 needs — one case, no keyed spend, and it must not be vacuous
...
5. File attempt 16 with `Supersedes` naming this path.
