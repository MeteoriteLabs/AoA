# QA Result — `M1-D1-SPINE`, M1a candidate, `7be35ae6b771`, attempt 16

**Date (UTC):** `2026-09-24`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1-d1-spine-m1a-candidate-7be35ae6b771-a16.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `16`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-24-m1-d1-spine-m1a-candidate-7be35ae6b771-a15.md`
**Lane:** `M1-D1-SPINE`
**Result:** `fail`
...
## 0.00000000000000000 Why attempt 16 exists — this gate cannot be passed on this candidate either
...
**Step 5 — file an attempt-1 record for the new candidate.** It does **not** supersede this chain: a different candidate is a different attestation, not a higher attempt.
