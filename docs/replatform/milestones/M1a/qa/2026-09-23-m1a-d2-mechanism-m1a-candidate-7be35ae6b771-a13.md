# QA Result — `M1a-D2-MECHANISM`, M1a candidate, `7be35ae6b771`, attempt 13

**Date (UTC):** `2026-09-23`
**Milestone:** `M1a`
**Record path:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a13.md`
**Scope slug:** `m1a-candidate`
**Revision:** `7be35ae6b7719877e61f54ab552de84de8491e7d`
**Attempt:** `13`
**Supersedes:** `docs/replatform/milestones/M1a/qa/2026-09-23-m1a-d2-mechanism-m1a-candidate-7be35ae6b771-a12.md`
...
## 0.00000000000 Why attempt 13 exists
...
`tests/d1/fault-matrix.json` therefore stands at **23 declared, 23 `pending`, 0 fired**. **Twenty-two** of the
`pending` rows are properly formed with `pendingKind: "keyed"`, a reason, and
`pendingOwner: "planning session (F8), on the DEP-015 lane"`. ★ **The twenty-third is NOT owned there**:
...
### 11.1 What a passing attempt 14 would need — three preconditions, not one step
...
**Then** file attempt 14 with `Supersedes` naming this path.
