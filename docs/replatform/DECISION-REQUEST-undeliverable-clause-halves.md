...
**★ RULED 2026-09-11 (founder direction, on the independent re-audit at HEAD `bd21e1abc`):** RULED -- the ruling fired 1.5 (DE-11 rescheduled), 1.1 (DE-01 read-half DECLINED, not funded), 1.3 (DE-12 amended-resolved), 1.4 (DE-20 amended-resolved), 1.2(c) (DE-27 weak reading = ordinary Group B/C work) and 1.6 (DE-17 un-bundled, then CORRECTED same day after a Codex P1 — 6a is NOT deliverable-now; both halves need the unbuilt worker→CP carrier, 6a simpler). The undisputed consequence: of E0-F013's SIX Group-D clause-halves, FIVE are now resolved or reclassified as achievable/ordinary work, leaving DE-17 (blocked on the missing post-fence-event carrier) as the ONLY audit clause still blocked on an unbuilt mechanism. ★ CONVENTION SETTLED 2026-09-11 (methodological): convention (ii) governs — the SAME one §7 already applies by counting DE-06/DE-14 among the closable eleven though their crossings stay `partial`. An amended-honest audit clause is resolved for the ceiling; the unbuilt underlying controls are E0-F011/E0-F014's concern, not this ceiling's. So DE-12, DE-20 and DE-27 leave the hard-blocked set, leaving DE-17 (BOTH halves blocked on the missing worker→CP carrier — 6a needs it to report the cleanup outcome, 6b needs it plus authority-typing) as the SOLE hard-block. THE CLOSABLE-EVER CEILING IS SIXTEEN (17 − DE-17). The open count is separate and unchanged: 12 open / 5 resolved (3 whole + 2 amended). A plan states SIXTEEN (16 = 17 − DE-17; the ceiling would rise to SEVENTEEN only if DE-17 closes WHOLE — BOTH 6a's cleanup-outcome carrier built AND 6b resolved (carrier + authority-typing, or 6b amended to an honest decline); resolving only one half leaves DE-17 open) and never quotes seventeen as already-achievable.
