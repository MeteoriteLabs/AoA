...
- **🔨 BUILDABLE NOW (session, no live infra) — best first:** (1) **E9 gate-clause-wiring guard** (the
  ...
  **E10 routing-seam + mint-generalization** (the honest Sprint-6 keystone that UNBLOCKS the sinks;
  ...
  E4-F013/E4-F015. **✅ Shipped 2026-08-27 (S9-3, foundation-suite-unrun):** the census's former "single
...
| rest of 6–9 | scope + sequence only (§4) | **★ UPDATED** — shipped since: S6 MIG-009 drain, S7-unit1 BRW-hostspawn-gate, S9-unit1 REL-FOUNDATION-GATE, S9-unit2 REL-003 core, S9-unit3 foundation-suite-unrun. **Still unwritten:** Sprint 8 (E9 — a buildable gate-clause guard unit + the blocked SVC feature chain), the E10 cutover sinks (blocked, E10-F001), REL-001/002/005 (blocked on S7/S8 + deps). **Step 1 of each remaining unit is: write the plan** just-in-time, so it can't go stale. |
