...
- ★ **THE AUTHORITATIVE CLASS-WIDE COUNT, as of 2026-09-10, stated once here because the dated
  ...
  (2026-09-10, later the same day).** ★ TWO MORE were RESOLVED BY AMENDMENT 2026-09-11 under E0-F013 Decision 1 — DE-12 (E0-F010) and DE-20 (this cohort): each has one conjunct delivered and its remaining conjunct(s) amended as vacuous, so each LEAVES its audit-gap cohort while staying `partial` in the register. This is resolution-by-amendment, NOT a whole delivery — the "three whole" count is unchanged. Class-wide: THREE whole-delivered + TWO amended-resolved = FIVE audit clauses no longer open; TWELVE remain. The "closable ever" ceiling is unchanged because both stay partial crossings. **FOURTEEN remain open** — DE-01, DE-03, DE-04, DE-11, DE-12,
...
| ~~DE-20 (Critical)~~ — **AUDIT CLAUSE RESOLVED BY AMENDMENT 2026-09-11 (Decision 1); STRUCK FROM THIS COHORT** | "cutover selection and rollback transitions are audited" | `server/src/services/heartbeat.ts:5399` → `:5451`. | **RESOLVED BY AMENDMENT (Decision 1).** 4a (cutover selection): DELIVERED for BOTH arms — one unconditional append at heartbeat.ts:5388 (buildCutoverSelectionEvent, TOTAL over RunExecutionOwner, W20-B 2026-09-10) writes a distributed_execution_selection row for distributed AND legacy. 4b (rollback transitions): AMENDED as VACUOUS — createDistributedExecutionDrain (job-distributed-drain.ts:114) has zero production callers, so no rollback transition occurs. Audit clause resolved; DE-20 leaves this cohort and stays `partial` in the register (its revocation clause still has no chartered exit — E0-F014/REL-005). |
