...
|---|---|---|---|---|
| [E0 Foundation](E0-foundation/) | `planning` | approved program design | FND-001–FND-008 | foundation checker, current-main crosswalk, cloud-plugin exclusion, focused config tests, repository verification |
...
| [E6 Deployment/test harness](E6-deployment-test-harness/) | `backlog` | E0; partial gate consumes E2 and E3/E4 core | DEP-000–DEP-009 | D1 topology, migration-0188 snapshot/marker preflight, reusable hostile isolation conformance, and two-replica HA; E2B evidence lands in E7/D2 |
