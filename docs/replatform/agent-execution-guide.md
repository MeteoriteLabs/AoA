...
3. [`accepted-caveats.md`](accepted-caveats.md) and [`test-gates.md`](test-gates.md).
4. [`artifact-policy.md`](artifact-policy.md).
5. The target epic README and implementation plan.
6. Completion handoffs, decisions, findings, and QA evidence from every dependency epic.
7. The assigned ticket and its owned interfaces.
