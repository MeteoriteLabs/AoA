...
The direction is ready for documentation and grooming. E1.0 is not fully closed; no release/branch/V1–V2 allocation is approved by this review. Next discussion follows this consolidated record and its remaining design-state gaps.
