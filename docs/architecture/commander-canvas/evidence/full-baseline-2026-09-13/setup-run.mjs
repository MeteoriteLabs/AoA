...
const unhandled=/Unhandled Errors|Unhandled Rejection|Uncaught Exception|JavaScript heap out of memory|ERR_WORKER_OUT_OF_MEMORY|Hook timed out|Test timed out|Failed to load url|Cannot find module|EADDRINUSE/.test(output);
let report=null;
