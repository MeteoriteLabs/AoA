...
const cwd='/workspace/integrated-baseline-20260913',dir='/workspace/integrated-baseline-20260913-logs';
const expectedSha='bef01d9cc6947e25ec87df21e747eafdbe497527';
...
const args=commands[label],phase=index<=9?'setup':'verification';
