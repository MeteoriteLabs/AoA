...
Separate from workspace system entirely. Implemented as a sidebar nav item + dedicated page. See `CLAUDE.md` §Commander (Internal Agent) for implementation details.
