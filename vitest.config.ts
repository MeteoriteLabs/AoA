...
export default defineConfig({
  test: {
    ...
    projects: ["packages/adapter-utils", "packages/shared", "packages/db", "packages/worker-protocol", "packages/worker-daemon", "packages/sandbox-provider-contract", "packages/sandbox-fake-provider", "packages/sandbox-e2b-provider", "packages/adapters/opencode-local", "packages/adapters/gemini-local", "packages/adapters/codex-local", "packages/adapters/claude-local", "packages/adapters/grok-local", "packages/adapters/pi-local", "packages/adapters/acpx-local", "packages/adapters/cursor-local", "packages/adapters/cursor-cloud", "packages/adapters/openclaw", "packages/adapters/openclaw-gateway", "server", "ui", "cli"],
  },
});
